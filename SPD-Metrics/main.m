...
% Kai-Xuan Chen, Xiao-Jun Wu, Jie-Yi Ren, Rui Wang and Josef Kittler. 
% More About Covariance Descriptors for Image Set Coding: Log-Euclidean Framework based Kernel Matrix Representation[C]. 
